/**
 * The `FileUtils` class provides utility methods for reading and writing double values to text and binary files.
 * It includes methods for writing to and reading from files, handling exceptions related to file operations.
 * The class supports both text and binary file formats.
 *
 * @author Your Name
 * @version 1.0
 * @since version 1.0
